...
def cum4x(w, x, y, z, maxlag=0, nsamp=0, overlap=0, flag='biased', k1=0, k2=0):
  ...
  Args:
      w: data vector or matrix
      x: data vector or matrix (same dimensions as w)
      y: data vector or matrix (same dimensions as w)
      z: data vector or matrix (same dimensions as w)
      ...
      k1: first fixed lag in the fourth-order cross-cumulant C4(m, k1, k2)
          [default = 0]
      k2: second fixed lag in the fourth-order cross-cumulant C4(m, k1, k2)
          [default = 0]

  Returns:
      y_cum: estimated fourth-order cross-cumulant sequence
